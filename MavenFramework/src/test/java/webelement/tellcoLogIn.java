...
public class tellcoLogIn {
    ...
    wait.until(ExpectedConditions.titleIs("Boards | Trello"));
    	...
    	if(driver.getTitle().equals(workbook.getSheet("Sheet1").getRow(1).getCell(2).getStringCellValue()+" | Trello")) {
			for(int r=1;r<=5;r++) {
			...
			for(int r=1;r<=5;r++) {
			wait.until(ExpectedConditions.elementToBeClickable((driver.findElement(By.xpath("//a[text()='Java']")))));
			if (driver.findElement(By.xpath("//a[text()='Java']")).getText().equals(workbook.getSheet("Sheet1").getRow(r).getCell(3).getStringCellValue())) {
				driver.findElement(By.xpath("//a[text()='Java']")).click();
				driver.findElement(By.xpath("//span[text()='Checklist']")).click();
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(workbook.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue());
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(Keys.ENTER);
				for(int r1=1;r1<=5;r1++) {
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(workbook.getSheet("Sheet1").getRow(r1).getCell(5).getStringCellValue());
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(Keys.ENTER);
				}
				driver.findElement(By.xpath("//span[@data-testid='CloseIcon']")).click();
			}
			else if (driver.findElement(By.xpath("//a[text()='Automation']")).getText().equals(workbook.getSheet("Sheet1").getRow(r).getCell(3).getStringCellValue())) {
				driver.findElement(By.xpath("//a[text()='Automation']")).click();
				driver.findElement(By.xpath("//span[text()='Checklist']")).click();
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(workbook.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue());
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(Keys.ENTER);
				for(int r1=1;r1<=5;r1++) {
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(workbook.getSheet("Sheet1").getRow(r1).getCell(6).getStringCellValue());
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(Keys.ENTER);
				}
				driver.findElement(By.xpath("//span[@data-testid='CloseIcon']")).click();
			}else if (driver.findElement(By.xpath("//a[text()='SQL']")).getText().equals(workbook.getSheet("Sheet1").getRow(r).getCell(3).getStringCellValue())) {
				driver.findElement(By.xpath("//a[text()='SQL']")).click();
				driver.findElement(By.xpath("//span[text()='Checklist']")).click();
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(workbook.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue());
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(Keys.ENTER);
				for(int r1=1;r1<=5;r1++) {
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(workbook.getSheet("Sheet1").getRow(r1).getCell(7).getStringCellValue());
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(Keys.ENTER);
				}
				driver.findElement(By.xpath("//span[@data-testid='CloseIcon']")).click();
			}else if (driver.findElement(By.xpath("//a[text()='Manual']")).getText().equals(workbook.getSheet("Sheet1").getRow(r).getCell(3).getStringCellValue())) {
				driver.findElement(By.xpath("//a[text()='Manual']")).click();
				driver.findElement(By.xpath("//span[text()='Checklist']")).click();
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(workbook.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue());
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(Keys.ENTER);
				for(int r1=1;r1<=5;r1++) {
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(workbook.getSheet("Sheet1").getRow(r1).getCell(8).getStringCellValue());
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(Keys.ENTER);
				}
				driver.findElement(By.xpath("//span[@data-testid='CloseIcon']")).click();
			}else if (driver.findElement(By.xpath("//a[text()='API']")).getText().equals(workbook.getSheet("Sheet1").getRow(r).getCell(3).getStringCellValue())) {
				driver.findElement(By.xpath("//a[text()='API']")).click();
				driver.findElement(By.xpath("//span[text()='Checklist']")).click();
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(workbook.getSheet("Sheet1").getRow(1).getCell(4).getStringCellValue());
				driver.findElement(By.xpath("//input[@id='id-checklist']")).sendKeys(Keys.ENTER);
				for(int r1=1;r1<=5;r1++) {
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(workbook.getSheet("Sheet1").getRow(r1).getCell(9).getStringCellValue());
					driver.findElement(By.xpath("//textarea[@data-testid='check-item-name-input']")).sendKeys(Keys.ENTER);
				}
				driver.findElement(By.xpath("//span[@data-testid='CloseIcon']")).click();
			}
